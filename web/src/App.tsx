...
function App() {
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <h1 className="text-6xl text-white font-black mt-20">Seu <span className="text-transparent bg-nlw-grandient bg-clip-text">duo</span> está aqui!</h1>
...
{/* ------- PUBLICAÇÃO -------  */}
      <div className="pt-1 bg-nlw-grandient self-stretch rounded-lg mt-8 overflow-hidden">
